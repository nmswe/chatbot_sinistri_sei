...
const sixSinisters = [
    { id: 1, src: '/villains/doc_ock.svg', alt: 'Doc Ock' },
    { id: 2, src: '/villains/electro.svg', alt: 'Electro' },
    { id: 3, src: '/villains/kraven.svg', alt: 'Kraven' },
    { id: 4, src: '/villains/mysterio.svg', alt: 'Mysterio' },
    { id: 5, src: '/villains/vulture.svg', alt: 'Vulture' },
    { id: 6, src: '/villains/sandman.svg', alt: 'Sandman' },
];
